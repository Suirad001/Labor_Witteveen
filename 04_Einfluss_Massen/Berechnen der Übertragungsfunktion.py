...
data = pd.read_excel("1_Komb_1r_5r_1.xlsx", header=None).iloc[1:, 0:3].values
...
pd.DataFrame(output_data, columns=["Time", "Frequenz", "Force", "Acceleration", "Real Part", "Imaginary Part", "Magnitude", "Phase"]).to_excel("1_Komb_1r_5r_1.Python.xlsx", index=False)
